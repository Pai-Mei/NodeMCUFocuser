...
//
// ASCOM Focuser driver for NodeMCUFocuser
//
...
namespace ASCOM.NodeMCUFocuser.Focuser
{
    ...
    //
    // Your driver's DeviceID is ASCOM.NodeMCUFocuser.Focuser
    //
    // The COM Guid attribute sets the CLSID for ASCOM.NodeMCUFocuser.Focuser
    // The COM ClassInterface/None attribute prevents an empty interface called _NodeMCUFocuser from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("9f58afea-87ed-4ccd-b9f3-0c97292de613")]
    //[Guid("9f34afea-87ed-4ccd-b9f3-0c97292de613")]
    [ProgId("ASCOM.NodeMCUFocuser.Focuser")]
    [ServedClassName("ASCOM NodeMCUFocuser")] // Driver description that appears in the Chooser, customise as required
    [ClassInterface(ClassInterfaceType.None)]
    public class Focuser : ReferenceCountedObjectBase, IFocuserV3, IDisposable
    {
        internal static string DriverProgId = "ASCOM.NodeMCUFocuser.Focuser"; // ASCOM DeviceID (COM ProgID) for this driver, the value is retrieved from the ServedClassName attribute in the class initialiser.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeMCUFocuser"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Focuser()
        {
            try
            {
                ...
                tl = new TraceLogger("", "NodeMCUFocuser.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
        ...
        public int MaxIncrement
        {
            get
            {
                try
                {
                    ...
                    int maxIncrement = FocuserHardware.Settings.MaxIncrement;
        ...
        public int MaxStep
        {
            get
            {
                try
                {
                    ...
                    int maxStep = FocuserHardware.Settings.MaxStepsCount;
