...
//
// ASCOM CoverCalibrator driver for SRNodeMCUPanel
//
...
namespace ASCOM.NodeMCUFocuser.CoverCalibrator
{
    ...
    //
    // Your driver's DeviceID is ASCOM.SRNodeMCUPanel.CoverCalibrator
    //
    // The COM Guid attribute sets the CLSID for ASCOM.SRNodeMCUPanel.CoverCalibrator
    // The COM ClassInterface/None attribute prevents an empty interface called _SRNodeMCUPanel from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("a12d36e0-5bce-4c0b-954a-e8a8034e3419")]
    [ProgId("ASCOM.SRNodeMCUPanel.CoverCalibrator")]
    [ServedClassName("ASCOM NodeMCUPanel")] // Driver description that appears in the Chooser, customise as required
    ...
    public class CoverCalibrator : ReferenceCountedObjectBase, ICoverCalibratorV1, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SRNodeMCUPanel"/> class. Must be public to successfully register for COM.
        /// </summary>
        public CoverCalibrator()
        {
            try
            {
                ...
                tl = new TraceLogger("", "SRNodeMCUPanel.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
